...
public class ProgressMonitorMultiple  extends JFrame implements ActionListener{
    static ProgressMonitor pbar;        //Objeto de la clase ProgressMonitor
    static int counter = 0;            //Atributo contador para la barra 

    public ProgressMonitorMultiple( ) { //Constructor de la clase
    ...
    public static void main(String args[]) {
        //Nombre de la ventana de la barra proceso
